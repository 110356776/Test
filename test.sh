...
if [ "$ARCH" == "arm" ] || [ "$ARCH" == "arm64" ] || [ "$ARCH" == "aarch64" ]; then
    FILE_INFO=("https://raw.githubusercontent.com/110356776/warehouse/main/Docker/ARM/bot bot" "https://raw.githubusercontent.com/110356776/warehouse/main/Docker/ARM/web web")
elif [ "$ARCH" == "amd64" ] || [ "$ARCH" == "x86_64" ] || [ "$ARCH" == "x86" ]; then
    FILE_INFO=("https://raw.githubusercontent.com/110356776/warehouse/main/Docker/AMD/bot bot" "https://raw.githubusercontent.com/110356776/warehouse/main/Docker/AMD/web web")
else
